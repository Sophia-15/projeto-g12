...
def infinity_runner():
  ...
  # Variável que define a velocidade que o jgador cai
  gravity = 1.5
  ...
  while running:
        ...
        obstacles4 = pygame.draw.rect(dispay, green, [obstacles[4], 600, 50, 50])
        ...
        if active == False:
            display.fill(22, 163, 74)
            result_text = font.render(f'Score final: {score}', True, white, (0,0,0))
            instfim_text = font.render(f'Aperte o botão vermelho para registrar seu score', True, white, (0,0,0))
