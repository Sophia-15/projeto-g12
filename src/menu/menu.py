...
import random
sys.path.append("..")  
from main_tetris import tetris_game
...
font = pygame.font.Font('c:/Users/gmam_cesar/Downloads/python/sr12/projeto-g12-main/src/menu/retro.ttf', 124)
font_sm = pygame.font.Font('c:/Users/gmam_cesar/Downloads/python/sr12/projeto-g12-main/src/menu/retro.ttf', 80)
          ...
          if event.type == pygame.KEYDOWN:
              ...
              if event.key == pygame.K_RETURN:
                  if letter != 2:
                      ...
                      score_csv.write(f'{"".join(name)}, {score}/n')
                      score_csv.close()
                      pygame.quit()
...
def infinity_runner():
  ...
  background = (0,0,0)
  fps = 60
  font = pygame.font.Font('c:/Users/gmam_cesar/Downloads/python/sr12/projeto-g12-main/src/menu/retro.ttf', 20)
  ...
  while running:
      ...
      obstacles3 = pygame.draw.rect(display, blue, [obstacles[3], 200, 20, 20])
      obstacles4 = pygame.draw.rect(display, orange, [obstacles[4], 200, 20, 20])
...
def tetris():
    execfile("C:/Users/gmam_cesar/Downloads/python/sr12/projeto-g12-main/src/tetris/main_tetris.py")
    # tetris_game()
    # main_tetris.tetris_game()
